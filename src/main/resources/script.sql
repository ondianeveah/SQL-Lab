...
INSERT INTO movies (title, runtime, genre, imdb_score, rating)
VALUES ('Matilda', '102', 'Family/Comedy', '6.9', 'PG');
INSERT INTO movies (title, runtime, genre, imdb_score, rating)
VALUES ('Bringing Down the House', '105', 'Comedy/Rom-com', '5.6', 'PG-13');
...
SELECT id, rating FROM movies WHERE genre IN ('Family/Comedy','Comedy/Rom-com');
